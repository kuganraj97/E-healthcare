...
<meta charset="utf-8" />
    ...
    <title>Delete Manager from Hospital</title>
...
<label style="font-size:20px" >State:</label>
		<select name="city" id="city-list" class="demoInputBox"  onChange="getState(this.value);"style="width:100%;height:35px;border-radius:9px">
		...
		<br><label style="font-size:20px" >Hospital:</label>
		<select id="clinic-list" name="clinic" onChange="getManager(this.value);" style="width:100%;height:35px;border-radius:9px" >
		<option value="">Select Hospital</option>
		</select><br>
		
		<br><label style="font-size:20px" >Manager:</label>
		<select name="manager" id="manager-list"style="width:100%;height:35px;border-radius:9px" >
...
if(isset($_POST['Submit']))
{
	...
	if (mysqli_query($conn, $sql1)) 
				{
							echo "Record created successfully( CID=$cid MID=$mid )";
							echo'<META HTTP-EQUIV="Refresh" Content="3;">';
