...
<label style="font-size:20px" >State:</label>
		<select name="city" id="city-list" class="demoInputBox"  onChange="getState(this.value);getManagerRegion(this.value);"style="width:100%;height:35px;border-radius:9px">
